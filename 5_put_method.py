...
class PatientUpdate(BaseModel):
        name: Annotated[Optional[str], Field(title='Name of the patient',
                                             description='Give the name of the patient in less than 50 chars',
                                             examples=['Ranit', 'Amit'])] = None
        city: Annotated[Optional[str], Field(description='City of the patient')] = None
        age: Annotated[Optional[int], Field(gt=0, lt=120)] = None
        gender: Annotated[
            Optional[Literal['male', 'female', 'others']], Field(description='Gender of the patient')] = None
        height: Annotated[Optional[float], Field(gt=0, description='Height of the patient in meters')] = None
        weight: Annotated[Optional[float], Field(gt=0, description='Weight of the patient in kg')] = None
